...
ISSUES_FILE = DATA_DIR / "tawos_10projects_full_issues.csv"
CHANGELOG_FILE = DATA_DIR / "tawos_10projects_full_changelog.csv"

OUTPUT_FILE = DATA_DIR / "tawos_10projects_full_history_dataset.csv"
...
print("=" * 70)
print("BUILDING FULL-HISTORY TAWOS DATASET")
print("=" * 70)

print("\nInput files:")
print("Issues   :", ISSUES_FILE)
print("ChangeLog:", CHANGELOG_FILE)
print("Output   :", OUTPUT_FILE)

print("\nIMPORTANT:")
print("All issues are included.")
print("All Change_Log records are included.")
print("All valid historical snapshots are included.")
print("There is NO snapshot limit per issue.")
...
# ============================================================
# REMOVE CHANGE EVENTS BEFORE ISSUE CREATION
# ============================================================
...
print("\nCreating ALL historical snapshots...")
...
print("\n" + "=" * 70)
print("FULL-HISTORY SNAPSHOT CREATION COMPLETE")
print("=" * 70)
